<div id="zpret-dialog" title="{{__('ZPRET')}}">
    ...
    <div style="display: block; overflow-y: scroll; max-height: 350px">
        <table id="zpretrecord_table" class="table-striped">
            <colgroup>
                <col width="5%">
                <col width="5%">
                <col width="5%">
...
<script>
            ...
            buttons: {
                "Take over": function () {
                    if (zpret_last_selected_line != null) {
                        ...
                        onselect_zpretrecord(zpretCaller, result_infnr, result_lifnr, result_lifnr_name, result_idnlf, result_mtext, result_matnr, result_purch_price, result_purch_currency);
                    }
                },
                Cancel: function () {
                    zpretDialog.dialog("close");
    ...
    function read_zpretrecords(caller, lifnr, idnlf) {
        ...
        $("#zpret-dialog").dialog('option', 'title', 'zprets');
        $("#zpret-lifnr").val("");
